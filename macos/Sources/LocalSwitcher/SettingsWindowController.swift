...
final class SettingsWindowController {
    ...
    private func populateSwitchHotkeyPopup(_ popup: NSPopUpButton) {
        ...
        // Совпадение обычно запрещено. Исключение - Shift+Shift: единый
        // распознаватель поддерживает один Shift для раскладки и двойной Shift
        // для конверсии без конфликта.
